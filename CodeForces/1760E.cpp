...
void solve(){
    ...
    ll maxFirst = 0 , maxSec = 0 , maxThi = 0;
    maxFirst = Maxi(arr , n ,  0);

    maxSec = addOne(arr , n);
    maxThi = addZer(arr , n);
    print(max3(maxFirst , maxSec , maxThi));
    // cout<< maxFirst << " " <<maxSec << " " << maxThi << " " <<endl;
    // print(maxThi);
